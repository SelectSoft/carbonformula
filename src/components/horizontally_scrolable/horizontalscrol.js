...
const list = [
  ...
  { name: "4. Water Supply", link: "waterSupply" },
  { name: "5. Water Disposal", link: "waterDisposal" },
  { name: "6. Material Use", link: "material-usage" },
  { name: "7. Water Treatment", link: "waterTreatment" },
  { name: "8. ReFrigrant usage", link: "reFrigrant-usage" },
  { name: "9. Heat and Steam", link: "heatnSteam-usage" },
];
