                ...
                <button className='col-md-1' style={{ backgroundColor: '#85B91C', border: 'none' }}>
                    ...
                    <div className="col-md-12">
                        ...
                        <div className="container" style={{ width: '100%'}}>
                            ...
                            <button className="btn btn-lg" style={{ backgroundColor: "gray" }}>XXX Tones</button> 
                            <br/><br/>
                            <button className="btn btn-lg" style={{backgroundColor: '#99d41f'}}>Get to carbon neutral</button>          
                        ...
                        <br/><br/>
                            <center>
                                <span className="col-sm-6">
                                    ...
                                    <p style={{ fontSize: '20px', textDecoration: 'underline', color: 'black' }}>
